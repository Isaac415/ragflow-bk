...
<ul>
  ...
  <li>The auto-keyword feature is dependent on the LLM and consumes a significant number of tokens.</li>
    ...
    chat: {
      ...
      deleteFolderConfirm:
        'Are you sure you want to delete this folder? Conversations will be moved to the root level.',
...
[Insert text here]`,
    ...
    explore: {
      ...
      deleteFolder: 'Delete folder',
      deleteFolderConfirm:
        'Are you sure you want to delete this folder? Sessions will be moved to the root level.',
      moveToFolder: 'Move to folder',
      removeFromFolder: 'Remove from folder',
      folderName: 'Folder name',
